...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $author = $_POST["author"];
    $ISBN = $_POST["ISBN"];
    $available = $_POST["email"];
    $owned= $_POST["password"];
   ...
   if(count($errors)==0){
       ...
       (firstname, lastname, ISBN, email, created, confirmation, password)
       VALUES
    ...
    <body>
        ...
        <div class="container1">
         <form method = "post" action ="register.php" id ="register">
            ...
            <input required type ="text" name = "ISBN" placeholder ="123456789" maxlength="10" value ="<?php echo $username;?>">
            <span class="errors">
